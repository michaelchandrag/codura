        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-lg-6 p-0">
            <div class="hero-video">
              <video autoplay muted loop playsinline>
                <source src="/assets/video/aurasisai.mp4" type="video/mp4" />
          ...
          <div class="col-lg-6 p-0">
            <div class="hero-text text-start">
              <div class="text-center fs-13px text-white mb-4">Bridging DeFi with the Power of AI</div>
              <h2 class="ls-sm fw-bold text-white fs-30px mb-4">Connecting DeFi and AI to Simplify, Optimize, and
                Empower
              ...
              <div v-if="company.key_ca" class="col-12 col-lg-10 pt-4">
            ...
            <div class="card-body p-5">
              ...
              <div class="d-flex align-items-start gap-2 mb-0">
                ...
                <div class="sub-info-description mt-1">
                  ...
                  <ul class="decimal ps-3 m-0 mb-3">
                  ...
                  <router-link :to="{ name: 'ai' }" class="bg-app btn btn-sm rounded text-white fs-12px py-2 px-3 d-inline-flex align-items-center gap-2"><i class="bi bi-chat-dots-fill"></i><span>Chat Now</span></router-link>
                </div>
              </div>
            </div>
          </div>
