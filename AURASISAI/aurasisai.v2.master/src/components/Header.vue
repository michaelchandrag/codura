  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      <router-link @click.prevent="changeMenu('home')" :to="{ name: 'home' }" class="logo d-flex align-items-center">
        <img src="/assets/img/aurasisai@4x.png" class="lg" alt="aurasisai" />
        ...
        <ul>
          ...
          <li class="d-inline-flex align-items-center gap-2">
            ...
            <a v-if="company.twitter_url || company.tw" target="_blank" :href="company.twitter_url || company.tw"
              class="btn btn-sm text-white p-2 social border rounded-sm"><i class="bi bi-twitter-x fs-14px m-0"></i></a>
            <a v-if="company.github_url || company.github" target="_blank" :href="company.github_url || company.github"
              class="btn btn-sm text-white p-2 social border rounded-sm"><i class="bi bi-github fs-14px m-0"></i></a>
          </li>
        </ul>
