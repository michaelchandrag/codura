      ...
      <div class="row gy-4 justify-content-center content-ai">
        <div class="col-lg-3 ai-history-sidebar p-0" :class="{ 'is-show': show_history }">
          <div class="ai-history-header mb-2 d-flex align-items-center justify-content-center px-4 pt-3">
            <a @click.prevent="addNewChat" class="btn btn-sm rounded text-white px-3 py-2 ws-80 align-items-center d-inline-flex justify-content-center"><i class="bi bi-plus fs-20px lh-normal"></i><span class="fs-13px">New
                Chat</span></a>
            <a @click.prevent="setShowSearch" class="d-none btn btn-sm rounded text-white"><i class="bi bi-search"></i></a>
          </div>
