      ...
      <div class="row gy-4 justify-content-center content-ai">
        <div class="col-lg-3 ai-history-sidebar" :class="{'is-show': show_history}" >
          <div class="ai-logo mb-2">
            <router-link @click.prevent="changeMenu('home')" :to="{ name: 'home' }"><img src="/assets/img/fluxheaven-logo.png"/></router-link>
          </div>
          <div class="card border-0 ai-history-content">
            <div class="ai-search p-3">
              <form>
                <div class="input-group m-0 rounded-sm bg-dark-light">
                  <span class="input-group-text bg-transparent text-dark-lighter border-0"><i class="bi bi-search"></i></span>
                  <input class="ps-0 fs-12px form-control form-control-md bg-transparent border-0 no-shadow text-white" placeholder="Search...">
                </div>
              </form>
            </div>
            <div
          ...
          <div class="card h-100 card-conversation border-0">
            <div
              ...
              <div class="d-inline-flex gap-2">
                <a @click.prevent="clearHistory();" class="btn btn-sm py-0 px-2 text-white fs-11px">
                  <i class="bi bi-arrow-repeat"></i>
                  <span class="ms-1">Clear Chat</span>
                </a>
                <a @click.prevent="showHistory();" class="d-xl-none d-lg-none btn btn-sm py-0 px-2 text-white fs-11px">History</a>
              </div>
            </div>
